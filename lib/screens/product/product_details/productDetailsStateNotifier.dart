...
//       addOnItemsPrice = selectedAddOnItems
//           .map((value) => value.addOnItemPrice! * value.quantity!.toDouble())
//           .reduce(
//             (_, __) => _ + __,
//           );
//     }
...
//     final productTax =
//         totalPrice * productDetails.taxInfo!.taxPercentage! / 100;

//     print(
//         'ssssssssssssssss $selectedAddOnItems $addOnItemsPrice $totalPrice $productTax');
...
//       state.productDetails!.copyWith.call(
//           selectedAddOnItems: selectedAddOnItems.toList(),
//           variant: selectedVariant,
//           totalQuantity: product.totalQuantity,
//           isSameProductMultipleTime: false);
...
//       final productTax =
//           totalProductPrice * productDetails.taxInfo!.taxPercentage! / 100;
...
//           .reduce((_, __) => _ + __);
//       final taxTotal =
//           cartData!.products.map((e) => e.tax).reduce((_, __) => _ + __);
//       // final grandTotal = cartTotal + taxTotal;
//       final grandTotal = cartTotal;
//       cart = cartData?.copyWith(
//           subTotal: cartTotal, taxTotal: taxTotal, grandTotal: grandTotal);
