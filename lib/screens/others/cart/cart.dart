              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Center(
                        child: custombuttonsm(context, 'OK, ENVIAR PEDIDO ${cart!.subTotal}... ${cart.grandTotal}', () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
    ...
    return ListView.builder(
        ...
        itemBuilder: (BuildContext context, int i) {
          ...
          return Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(cart.products[i].productName!, style: textBlackLargeBM20(context)),
              SizedBox(height: 10),
              Row(
                ...
                children: [
                  Row(
                    children: [
                      ...
                      SizedBox(width: 4),
                      cartProduct.allergens!.isNotEmpty ? Container(
