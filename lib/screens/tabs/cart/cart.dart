                                                              ...
                                                              : DB().getOrderId() ==
                                                                  ...
                                                                  ? custombuttonsm(
                                                                      ...
                                                                      if (state
                                                                        ...
                                                                        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                                                                            content:
                                                                                Text('${state.orderResponse!.message}')));
                                                                      }
                                                                      Timer(
                                                                          Duration(
                                                                              seconds: 2),
                                                                  ...
                                                                  : cart.products
                                                                      ...
                                                                      ? custombuttonsm(
                                                                          ...
                                                                          if (updateResponse !=
                                                                              null) {
                                                                            ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('$updateResponse')));
