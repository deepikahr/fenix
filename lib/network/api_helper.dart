...
import 'package:restaurant_saas/models/api_response_models/base_response/base_response.dart';
...
class ApiHelper {
  ...
  Dio _getDio() {
    ...
    dio.options.queryParameters['lat'] =
        db.getLocalAddress()?.location?.coordinates[1];
    dio.options.queryParameters['long'] =
        db.getLocalAddress()?.location?.coordinates[0];
