...
class _$ProductDetailsResponseTearOff {
  ...
  _ProductDetailsResponse call(
      ...
      @JsonKey(ignore: true) bool modified = false}) {
...
mixin _$ProductDetailsResponse {
  ...
  int get variantQuantity => throw _privateConstructorUsedError;
...
abstract class $ProductDetailsResponseCopyWith<$Res> {
  ...
  $Res call(
      ...
      VariantResponse? variant,
      String? productInstructions,
      @JsonKey(ignore: true) bool modified});
...
class _$_ProductDetailsResponse extends _ProductDetailsResponse {
  const _$_ProductDetailsResponse(
      ...
      @JsonKey(ignore: true) this.modified = false})
      : super._();
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _ProductDetailsResponse &&
            ...
            (identical(other.variantQuantity, variantQuantity) || const DeepCollectionEquality().equals(other.variantQuantity, variantQuantity)) &&
...
abstract class _ProductDetailsResponse extends ProductDetailsResponse {
  const factory _ProductDetailsResponse(
      ...
      VariantResponse? variant,
      String? productInstructions,
      @JsonKey(ignore: true) bool modified}) = _$_ProductDetailsResponse;
